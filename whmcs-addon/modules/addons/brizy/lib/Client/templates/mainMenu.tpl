{if $wp && ($canInstallFree || $hasAssignedBrizyLicense)}
                    ...
                    <span id="builder-loader"> Module loading... <span>
                            <script>
                                setTimeout(() => {
                                    ...
                                    if (builderLoader) {
                                        builderLoader.innerHTML =
                                            'Failed to load the module, please contact the administrator.'
                                    }
                                }, 5000)
                            </script>
                </app-brizy-installer>
                    ...
                    <div class="col-xl-4 col-md-6 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    {$_lang['client']['template']['serviceMenu']['buyProHeader']['par1'] } {$bPluginName}
                                    {$LANG['client']['template']['serviceMenu']['buyProHeader']['par2']}
                                </p>
...
{if $cloud}
    ...
    <div class="panel card panel-default mb-3" id="brizy-cloud">
        <div class="panel-heading card-header">

            <h3 class="panel-title card-title m-0 d-flex justify-content-between" style="display:flex; justify-content:space-between;">
                {$cloud_website_builder_name}
                {if $cloud_website_builder_logo_path}
                    <img class="" style="height:22px" src="{$cloud_website_builder_logo_path}" alt="Brizy Cloud">
                {/if}
            </h3>
        </div>
        ...
        <div class="panel-body card-body ">
            <div>
                <div class="col-12">
                    <app-brizy-cloud-manager id="brizy-cloud-manager" service-id="{$serviceId}" deploy="{$cloudDeploy}">

                        <div class="panel card panel-default mb-3" id="brizy-cloud">
                            <div class="panel-heading card-header">
                                <h3 class="panel-title card-title m-0">Brizy cloud</h3>
                            </div>

                            <div class="panel-body card-body text-center">
                                <div class="row cpanel-feature-row">
                                    <div class="col-12">
                                        <span id="brizy-cloud-loader"> Module loading... <span>
                                    </div>
                        ...
                        <script>
                            setTimeout(() => {
                                const builderLoader = document.getElementById('brizy-cloud-loader');
                                if (builderLoader) {
                                    builderLoader.innerHTML =
                                        'Failed to load the module, please contact the administrator.'
                                }
...
{literal}
    ...
    <style type="text/css">
        @font-face{font-family:'Material Icons';font-style:normal;font-weight:400;src:url(https://fonts.gstatic.com/s/materialicons/v143/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2) format('woff2');}.material-icons{font-family:'Material Icons';font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:'liga';-webkit-font-smoothing:antialiased;}
    </style>
{/literal}